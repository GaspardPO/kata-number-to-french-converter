...
describe 'NumberParser' do
  ...
  context "from thousand to millions. Like vingt and cent, mille can be plural" do
    ...
    it('translate 9999 to neuf-mille-neuf-cent-quatre-vingt-dix-neuf') { expect(translate_to_french(9_999)).to eql 'neuf-mille-neuf-cent-quatre-vingt-dix-neuf' }
    it('translate 10000 to dix-milles, with an S') { expect(translate_to_french(10_000)).to eql 'dix-milles' }
    it('translate 20000 to vingt-milles, with an S') { expect(translate_to_french(20_000)).to eql 'vingt-milles' }
    it('translate 80000 to quatre-vingt-milles, with an S at mille but not vingt') { expect(translate_to_french(80_000)).to eql 'quatre-vingt-milles' }
    it('translate 100000 to cent-milles, with an S') { expect(translate_to_french(100_000)).to eql 'cent-milles' }
    it('translate 153622 to cent-cinquante-trois-mille-six-cent-vingt-deux') { expect(translate_to_french(153_622)).to eql 'cent-cinquante-trois-mille-six-cent-vingt-deux' }
    it('translate 153622 to cent-cinquante-trois-mille-six-cent-vingt-deux') { expect(translate_to_french(153_622)).to eql 'cent-cinquante-trois-mille-six-cent-vingt-deux' }
    it('translate 999999 to neuf-cent-quatre-vingt-dix-neuf-mille-neuf-cent-quatre-vingt-dix-neuf') { expect(translate_to_french(999_999)).to eql 'neuf-cent-quatre-vingt-dix-neuf-mille-neuf-cent-quatre-vingt-dix-neuf' }
  end
  ...
  context "specific rule for Et when number ends with 1 are still working for thousands" do
    ...
    it('translate 51051 to cinquante-et-un-mille-cinquante-et-un, with et in both thousand and units') { expect(translate_to_french(51_051)).to eql 'cinquante-et-un-mille-cinquante-et-un' }
    it('translate 81081 to quatre-vingt-un-mille-quatre-vingt-un, without et') { expect(translate_to_french(81_081)).to eql 'quatre-vingt-un-mille-quatre-vingt-un' }
    it('translate 51081 to cinquante-et-un-mille-quatre-vingt-un, with et in thousand but not in units') { expect(translate_to_french(51_081)).to eql 'cinquante-et-un-mille-quatre-vingt-un' }
    it('translate 81051 to quatre-vingt-un-mille-cinquante-et-un, with et in units but not in thousands') { expect(translate_to_french(81_051)).to eql 'quatre-vingt-un-mille-cinquante-et-un' }
  end
end
